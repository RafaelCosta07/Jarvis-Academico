...
export default function AgendaEventItem({ evento }: AgendaEventItemProps) {
  ...
  return (
    <div className={`border-l-2 pl-3 py-1 rounded-sm transition-all duration-200 cursor-default hover:-translate-y-0.5 hover:shadow-2 ${BORDER_COLOR[evento.tipo]}`}>
